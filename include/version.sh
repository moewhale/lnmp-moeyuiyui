...
if [ "${DBSelect}" = "1" ]; then
    ...
    Mysql_Ver='mysql-8.0.43'
elif [ "${DBSelect}" = "6" ]; then
    Mysql_Ver='mysql-8.4.6'
    ...
    Mariadb_Ver='mariadb-10.6.24'
elif [ "${DBSelect}" = "11" ]; then
    Mariadb_Ver='mariadb-10.11.15'
elif [ "${DBSelect}" = "12" ]; then
    Mariadb_Ver='mariadb-11.4.9'
elif [ "${DBSelect}" = "13" ]; then
    Mariadb_Ver='mariadb-11.8.5'
fi
if [ "${PHPSelect}" = "1" ]; then
    Php_Ver='php-5.2.17'
...
if [ "${ApacheSelect}" = "1" ]; then
    ...
    Apache_Ver='httpd-2.4.65'
fi

Pureftpd_Ver='pure-ftpd-1.0.52'

XCache_Ver='xcache-3.2.0'
ImageMagick_Ver='ImageMagick-7.1.2-3'
Imagick_Ver='imagick-3.8.0'
ZendOpcache_Ver='zendopcache-7.0.5'
Redis_Stable_Ver='redis-8.4.0'
