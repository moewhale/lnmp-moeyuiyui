...
在軍哥大佬脚本的基礎上，增加對新版本的支援，替換原有的探針工具，lnmp 於 debian 13 通過部署測試，沒有測試在其它 OS 上的部署。安裝前請確保系統純净。
